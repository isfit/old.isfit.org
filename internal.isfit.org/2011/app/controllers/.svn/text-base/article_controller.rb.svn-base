class ArticleController < ApplicationController
	...
	# Birthday stuff!
	@users = LdapUser.search("ou=isfit11,ou=units,dc=isfit,dc=org", true, "objectClass=inetOrgPerson", 
  ...
  def create
      ...
      @user_units = LdapUnit.get_by_dn("ou=isfit11,ou=units,dc=isfit,dc=org").units      
      @units = []
			@units.push(["Everyone","ou=isfit11,ou=units,dc=isfit,dc=org"])
