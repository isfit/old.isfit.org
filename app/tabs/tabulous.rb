...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :photos_subtab                      ,   t('tabs.articles.photos')                     ,    photos_path                                                          ,    true        ,    true        ],
      [    :articles_archive_subtab           ,    t('tabs.articles.archive')                  ,    root_path                                                          ,    true        ,    true        ],
      [    :articles_galleries_subtab         ,    t('tabs.articles.galleries')                ,    root_path                                                          ,    true        ,    true        ],
      [    :theme_tab                         ,    t('tabs.theme.main')             ,    photos_path                                                        ,    true        ,    false        ],
      [    :theme_globaltrade_subtab          ,    t('tabs.theme.globaltrade')             ,    photos_path                                                        ,    true        ,    true        ],
      [    :theme_workshops_subtab            ,    t('tabs.theme.workshops')                ,    workshops_path                                                        ,    true        ,    true        ],
      [    :theme_tradeyourideas_subtab       ,    t('tabs.theme.tradeyourideas')         ,    ideas_path                                                        ,    true        ,    true        ],
      [    :theme_themeblog_subtab            ,    t('tabs.theme.themeblog')               ,    photos_path                                                        ,    true        ,    true        ],
      [    :theme_previousthemes_subtab       ,    t('tabs.theme.previousthemes')          ,    photos_path                                                        ,    true        ,    true        ],
      [    :about_tab                         ,    t('tabs.about.main')                    ,    photos_path                                                        ,    true        ,    false        ],
      [    :about_whatisisfit_subtab          ,    t('tabs.about.whatisisfit')                    ,    photos_path                                                        ,    true        ,    true        ],
      [    :about_dialoguegroups_subtab       ,    t('tabs.about.dialoguegroups')          ,    photos_path                                                        ,    true        ,    true        ],
      [    :about_conflictareas_subtab        ,    t('tabs.about.conflictareas')           ,    photos_path                                                        ,    true        ,    true        ],
      [    :about_studentpeaceprice_subtab    ,    t('tabs.about.studentpeaceprice')      ,    photos_path                                                        ,    true        ,    true        ],
      [    :about_walkofpeace_subtab          ,    t('tabs.about.walkofpeace')            ,    photos_path                                                        ,    true        ,    true        ],
      [    :info_tab                          ,    t('tabs.info.main')                     ,    photos_path                                                        ,    true        ,    false        ],
      [    :info_participant_subtab           ,    t('tabs.info.participant')              ,    participants_path                                                        ,    true        ,    true        ],
      [    :info_volunteer_subtab             ,    t('tabs.info.volunteer')                ,    positions_path                                                     ,    true        ,    true        ],
      [    :info_press_subtab                 ,    t('tabs.info.press')                    ,    photos_path                                                        ,    true        ,    true        ],
