...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :positions_more_info_subtab        ,    t('tabs.positions.more_info') , page_path(80), false, true],
      [    :positions_form_subtab             ,    t('tabs.positions.form')   ,   apply_positions_path, false, true],
      [    :positions_info_subtab             ,    t('tabs.positions.info')   ,   page_path(81), false, true],
      ...
      [    :theme_labour_subtab          ,    t('tabs.theme.coming')             ,    page_path(83)                                                        ,    true        ,    true        ],
