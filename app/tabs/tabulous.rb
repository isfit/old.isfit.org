...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :articles_tab                      ,    'News'                     ,    root_path                                                          ,    true        ,    false        ],
      [    :photos_subtab                      ,    'Photos'                     ,    photos_path                                                          ,    true        ,    true        ],
      [    :articles_archive_subtab           ,    'Archive'                  ,    root_path                                                          ,    true        ,    true        ],
      [    :articles_galleries_subtab         ,    'Galleries'                ,    root_path                                                          ,    true        ,    true        ],
      [    :theme_tab                         ,    'Theme 2013'               ,    photos_path                                                        ,    true        ,    false        ],
      ...
      [    :about_tab                         ,    'About'                    ,    photos_path                                                        ,    true        ,    false        ],
      [    :about_whatisisfit_subtab          ,    'What is ISFiT?'                    ,    photos_path                                                        ,    true        ,    true        ],
      ...
      [    :info_tab                          ,    'Info'                     ,    photos_path                                                        ,    true        ,    false        ],
