...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :blogs_tab                   ,    t('tabs.blogs.main' )                     ,    photos_path                                                        ,    true        ,    false        ],
      [    :blogs_theme_subtab                   ,    t('tabs.blogs.theme' )                     ,   Language.to_s == 'no' ? 'http://isfit.github.com/blog/no.html' : 'http://isfit.github.com/blog/en.html'                                                         ,    true        ,    true        ],
      [    :blogs_festival_subtab                   ,    t('tabs.blogs.festival' )                     ,    Language.to_s == 'no' ? 'http://isfit2013.blogspot.com' : 'http://isfit2013eng.blogspot.com'                                                      ,    false        ,    false        ],
