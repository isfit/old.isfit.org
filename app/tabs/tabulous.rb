...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :workshops_tab                     ,    'Workshops'                ,    root_path                                                     ,    true       ,    false       ],
      [    :workshops_info_subtab                     ,    'Alle'                ,    workshops_path                                                     ,    true       ,    true       ],
      [    :participants_tab                  ,    'Participants'             ,    root_path                                                  ,    true       ,    false       ],
      [    :participants_info_subtab             ,    'Deltaker'             ,    participants_path                                                  ,    true       ,    true       ],
      [    :dialogue_participants_tab         ,    'Dialogue Participants'    ,    root_path                                         ,    true       ,    false       ],
      [    :dialogue_participants_info_subtab         ,    'Dialog'    ,    dialogue_participants_path                                         ,    true       ,    true       ],
      [    :articles_tab                      ,    t('tabs.articles.main')                     ,    root_path                                         ,    false        ,    false       ],
      ...
      #[    :applicant_users_new_subtab         ,    'New Applicant user'       ,    new_applicant_user_path                                            ,   false        ,    false       ],
      [    :positions_tab                     ,    t('tabs.positions.main')        ,   root_path                                                      , false,    false       ],
      ...
      [    :theme_tab                         ,    t('tabs.theme.main')             ,    photos_path                                                        ,    false        ,    false        ],
      ...
      [    :about_tab                         ,    t('tabs.about.main')                    ,    photos_path                                                        ,    false        ,    false        ],
      ...
      [    :ambassadors_tab                   ,    'Ambassadører'                          ,    root_path                                              , true, false ],
      [    :ambassadors_new_subtab            ,    'Søk'                                   ,    ambassadors_new_path, true ,true],
      [    :info_tab                          ,    t('tabs.info.main')                     ,    photos_path                                                        ,    false        ,    false        ],
  ...
  config.actions do
    [
      ...
      [    :ambassadors              ,    :all_actions    ,    :ambassadors_tab              ],
